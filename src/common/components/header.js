    ...
    <nav className="bg-[#248de4] sticky top-0 z-20">
      <header className="flex h-20 w-full shrink-0 items-center px-4 md:px-6 bg-[#248de4] from-[#248de4] to-[#0c5397] shadow-lg max-w-[1920px] mx-auto ">
        ...
        <div className="flex justify-start items-center w-full">
          ...
          <button variant="outline" className="text-white-10  whitespace-nowrap text-ellipsis cursor-pointer bg-black-10 h-10 px-3 rounded-sm">
            Login
          </button>
          <button variant="outline" className="text-black whitespace-nowrap text-ellipsis cursor-pointer bg-white-10 px-3 h-10 text-center grid place-items-center rounded-sm">
            Sign Up
            </button>
        </div>
          </div>
